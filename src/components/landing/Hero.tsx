    ...
    <header className="flex flex-col items-center p-4 md:p-6 rounded-2xl">
      ...
      <div className="mt-10 md:mt-[60px] px-4 w-full mb-0">
        <img
          ...
          className="aspect-[1.68] object-contain w-full max-w-[780px] mx-auto hover:scale-105 transition-transform duration-500 translate-y-[60px] md:translate-y-[120px]"
        />
      </div>
    </header>
  );
