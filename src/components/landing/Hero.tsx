...
const Hero: React.FC = () => {
  return <header className="flex flex-col items-center">
      <h1 className="text-black font-bold leading-[60px] text-center mt-[159px] max-md:max-w-full max-md:leading-[59px] max-md:mt-10 text-[3C315B]">
      ...
      <img src="https://cdn.builder.io/api/v1/image/assets/bbaf03e746c54fdab851e2e8fa65b939/28094319b78a85233278e4f17a4e3e2b46bcc4fe?placeholderIfAbsent=true" alt="HyperLend Platform" className="aspect-[1.68] object-contain w-[806px] max-w-full mt-[50px] max-md:mt-10" />
    </header>;
};
export default Hero;