  ...
  return (
    <header className="flex flex-col items-center p-4 md:p-6 rounded-2xl">
      <div className="flex flex-col items-center">
        <img 
          src="/lovable-uploads/39f4688e-1183-4ea5-af96-5482ddbfaf48.png"
          alt="Ping Logo"
          className="h-[18px] md:h-[20px] mb-2 md:mb-3"
        />
        <h1 className="text-[#000000] text-3xl md:text-[48px] font-bold leading-tight md:leading-[60px] text-center mt-2 md:mt-[8px] max-w-full text-shadow-sm">
