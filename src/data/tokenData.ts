...
export const allTokens: TokenInfo[] = [
  ...
  // Removed duplicate Bitcoin image that was between USDT and Gnosis
  ...
  // Removed duplicate Doge image that was between USDC and NEAR
  ...
  // Updated Doge coin with borderless version
  { id: "coin15", imagePath: "/lovable-uploads/8382b049-27d6-4ad3-9478-cb95d92e422c.png" }, 
  ...
  // Updated Dog with hat coin (WIF) with borderless version
  { id: "coin21", imagePath: "/lovable-uploads/c8e0cd61-f01b-4a79-9acd-02a407a2bbd7.png" }, 
  // Updated XRP coin with borderless version
  { id: "coin22", imagePath: "/lovable-uploads/351e2785-aa5d-4e99-9189-4dcb738d404a.png" }, 
  // Updated Zcash coin with borderless version
